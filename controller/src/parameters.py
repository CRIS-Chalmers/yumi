...
class Parameters():
    ...
    gripperLeftLocal = utils.FramePose(position=np.array([0, 0, 0.163]), quaternion=np.array([0, 0, 0, 1]))
    yumiToWorldLocal = utils.FramePose(position=np.array([0.181, 0, 0]), quaternion=np.array([0, 0, 0.7071, -0.7071]))
    harnessBord = utils.FramePose(position=np.array([0.0, 0, 0]), quaternion=np.array([0, 0, 0.0, 1.0]))
